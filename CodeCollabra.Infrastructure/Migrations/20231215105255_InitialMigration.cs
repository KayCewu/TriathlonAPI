    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatGptSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatGptSessions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatGptResponses_ChatGptSessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "ChatGptSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ChatParticipantBadges",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatParticipantBadges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatParticipantBadges_Badges_BadgesId",
                        column: x => x.BadgesId,
                        principalTable: "Badges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatParticipantBadges_ChatParticipants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatGptResponses_SessionId",
                table: "ChatGptResponses",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatGptSessions_UserId",
                table: "ChatGptSessions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipantBadges_BadgesId",
                table: "ChatParticipantBadges",
                column: "BadgesId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipantBadges_ParticipantId",
                table: "ChatParticipantBadges",
